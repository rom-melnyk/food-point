...
--
-- Host: localhost    Database: food_point
-- ------------------------------------------------------
...
INSERT INTO `dishes` VALUES (1,'/',0,NULL,NULL,1,'');
...
CREATE TABLE `users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `authType` enum('native','facebook') NOT NULL DEFAULT 'native',
  `authId` varchar(45) DEFAULT NULL,
  `name` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2016-01-03 20:10:14
